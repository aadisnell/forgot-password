...
<nav class="navbar navbar-default">
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://www.eggslab.net/">Eggs Lab</a></div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="defaultNavbar1">
      <ul class="nav navbar-nav">
        <li><a href="http://www.eggslab.net/forgot-password-recovery-script-using-php-and-mysqli">Tutorial Link</a></li>
        <li><a href="http://demos.eggslab.net/">More Demos</a></li>
      </ul>
